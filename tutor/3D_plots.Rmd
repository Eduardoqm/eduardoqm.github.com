...
```{r interativo}
plot_ly(x = df$gdpPercap, y = df$lifeExp, z = df$pop, color = df$continent, size = I(30))
```
...
[![Foo](img/rsolved2.png)](http://rsolved.tk/) Access our research tool here.